...
story_table = {
  {
    ...
    },
    {
      init = function()
        ...
        game.forces.player.set_turret_attack_modifier("laser-turret", -0.5)
    ...
    },
    {
      ...
      init = function()
        ...
        set_info()
        player.get_quickbar().insert{name = "construction-robot"}
    ...
    },
    {
      ...
      condition = function()
        for k, ghost in pairs (surface().find_entities_filtered{name = "entity-ghost"}) do
          if ghost.ghost_name == "radar" then
    ...
    },
    {
      ...
      update = function()
        set_goal({"place-ghost-entities-goal", surface().count_entities_filtered{name = "entity-ghost"}, 5}, true)
      end,
      condition = function()
        return surface().count_entities_filtered{name = "entity-ghost"} >= 5
      end,
      action = function()
        for k, ghost in pairs (surface().find_entities_filtered{name = "entity-ghost"}) do
